...
public class ReplenishmentTaskEntity {
    ...
    /** 配送区域，来自料号映射。用于仓库任务排序（第一优先级）与定时按区域打标签。 */
    ...
    /** 打印作业当前状态：RENDERED/SENT/PRINTED/FAILED/CANCELLED，用于仓库任务页和本地代理状态联动。 */
    private String printStatus;
    /** 打印方式：BROWSER=浏览器打印，AGENT=本地代理自动打印。 */
    private String printChannel;
    private LocalDateTime printedAt;
    private String printLastError;
