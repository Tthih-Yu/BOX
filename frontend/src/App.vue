  ...
  <el-container v-else class="app-shell">
    <el-aside width="238px" class="aside">
      ...
      <el-menu router :default-active="$route.path" class="menu">
        ...
        <el-sub-menu index="system" v-if="canAny(['/users','/menu-permissions','/configs'])">
          <template #title><el-icon><Setting /></el-icon>系统管理</template>
          <el-menu-item v-if="can('/users')" index="/users">用户角色</el-menu-item>
          <el-menu-item v-if="can('/menu-permissions')" index="/menu-permissions">菜单权限</el-menu-item>
...
import { canRoute, canAnyRoute, routeTitle as getRouteTitle, resetMenuWhitelist } from './permissions'
